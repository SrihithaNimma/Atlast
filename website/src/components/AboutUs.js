...
import image2 from '../images/truck.png'
function AboutUs() {
  ...
  return (
    ...
    {/*    <div className='card2' 
      ...
      <motion.h2 Layout="position" >Gopichand Anumolu</motion.h2>
        ...
        <div className='heading'>
      <motion.h2 Layout="position" >Suprith Srivikat</motion.h2>
        <motion.p Layout="position" className='designation'>Product Design Engineer</motion.p>
        </div>
        {card2==4 && (
        ...
        className='expand d-flex'>
        <div>
        <motion.p className='p' width="400px">Suprith is the design engineer of the company. The skeleton and body analysis is designed and simulated by Suprith.</motion.p>
